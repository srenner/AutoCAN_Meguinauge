...
ISR(CANIT_vect) {
  ...
  if(true) 
  {
    ...
    {
      case 1512:
        clearBuffer(can1512.data[0]);
        can1512.id = canTemp.id;
        for(int i = 0; i < 8; i++)
        {
